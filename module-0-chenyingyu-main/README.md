...
>
>Instruction: Provide one example where the model successfully classifies the points. Please add both the visualization and the relevant parameters directly into the README.md file!

#### Example Run
Below is one example where the model successfully classifies the points.
**Parameters**
- Dataset: Split (Number of points: 50)
- Size of hidden layer: 10
- Learning Rate: 0.1
- Number of epochs: 1000
<img width="750" height="810" alt="image" src="https://github.com/user-attachments/assets/f51a2470-68bc-46cb-9dee-756ff3b91b87" />
<img width="750" height="810" alt="image" src="https://github.com/user-attachments/assets/1ae0aa7d-815c-44c8-a5ad-f371515f944a" />
<img width="750" height="410" alt="image" src="https://github.com/user-attachments/assets/e11d6d3e-e8e7-48f5-8a02-ac79ed598734" />
