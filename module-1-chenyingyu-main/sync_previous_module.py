...
Examples:
    python sync_previous_module.py ./my-awesome-module-0 ./my-awesome-module-1
    python sync_previous_module.py ~/assignments/Module-0-unicorn_ninja ~/assignments/Module-1-unicorn_ninja
"""
import os
import shutil
import sys
